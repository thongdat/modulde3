...
CHANGE COLUMN co_cmnd so_cmnd VARCHAR(20);
...
alter table khach_hang add column gioi_tinh bit(1);
ALTER TABLE khach_hang DROP COLUMN luong;
...
ALTER TABLE dich_vu
CHANGE COLUMN mo_ta_tien_nghi_khach mo_ta_tien_nghi_khac VARCHAR(20);
...
select k.ho_ten, count(*) as so_luong
from khach_hang k
